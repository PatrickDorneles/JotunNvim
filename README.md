...
Jotun Nvim targets *only* the latest
...
```sh
git clone https://github.com/PatrickDorneles/JotunNvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```sh
git clone https://github.com/PatrickDorneles/JotunNvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```sh
git clone https://github.com/PatrickDorneles/JotunNvim.git "${env:LOCALAPPDATA}\nvim"
```
...
After installing all the dependencies continue with the [Install JotunNvim](#Install-Jotun-Nvim) step.
